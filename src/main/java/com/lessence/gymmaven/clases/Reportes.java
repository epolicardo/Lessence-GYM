...
//            JasperPrint informe = JasperFillManager.fillReport(rutaInforme, null, conexion.Conexion());
//            JasperExportManager.exportReportToPdfFile(informe, archi);
//
//
//
//            JasperViewer ventanavisor = new JasperViewer(informe, true);
...
//                    JasperPrint informe = JasperFillManager.fillReport(rutaInforme, parametros, conexion.Conexion());
//                                        
