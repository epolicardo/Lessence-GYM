...
//            Logger.getLogger(Form_AltaHorarios.class.getName()).log(Level.SEVERE, null, ex);
//        }
    }
...
//        jCDias.setSelectedIndex(0);
    ...
    private void jBAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAñadirActionPerformed
        ...
        if (jTTurno.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Debe ingresar el nombre de una actividad", "Carga de Horarios", ERROR);
